...
class SemanticAnalyzer:
    ...
    def __init__(self):
        ...
        self.character_mapping_file = config.project_root / "data" / "input" / "character_mapping.json"
...
- new_name字段需严格遵循"数量+着装风格+性格特征+外貌特征+年龄性别+种族"格式（要简洁），例：例子："1个穿着便携宇航服的中等体型的刚毅神情的年轻男人"，"3个穿着破烂衬衫的肥胖体型的颓废老男人"
